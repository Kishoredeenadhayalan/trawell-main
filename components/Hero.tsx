    ...
    >
      ...
      <div className="relative flex items-center h-full">
        <div className="container mx-auto px-6 lg:px-12 xl:px-24 mb-32">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-serif font-bold text-white drop-shadow-[0_0_6px_rgba(0,0,0,0.5)] tracking-wider mb-2 md:mb-4 whitespace-normal sm:whitespace-nowrap break-words">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-serif font-bold text-white drop-shadow-[0_0_6px_rgba(0,0,0,0.5)] tracking-wider mb-6 whitespace-normal sm:whitespace-nowrap break-words">
