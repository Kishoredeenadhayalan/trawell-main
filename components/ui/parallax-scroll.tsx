...
export const ParallaxScroll = ({
  ...
  return (
    <div
      className={cn(
        "h-fit items-start overflow-y-auto no-scrollbar w-full",
        className
      )}
      ref={gridRef}
    >
      <div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start w-full max-w-7xl mx-auto gap-10"
        ref={gridRef}
      >
